...
pygame.display.set_caption("Dino Run - Dev.D ")
...
class Ground():
    def __init__(self,speed=-5):
        self.image,self.rect = load_image('cloud.png',-1,-1,-1)
        self.image1,self.rect1 = load_image('cloud.png',-1,-1,-1)
...
def introduction_screen():
    ...
    t_ground,t_ground_rect = load_sprite_sheet('cloud.png',15,1,-1,-1,-1)
